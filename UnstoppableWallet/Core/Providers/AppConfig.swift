...
struct AppConfig {
    static let label = "Tipped Crypto"//"io.horizontalsystems.unstoppable"
    static let backupSalt = "TippedCrypto"//"unstoppable"

    static let companyName = "Tipped Crypto"//"Horizontal Systems"
    static let reportEmail = "blocktechbrew.com"//"support.unstoppable@protonmail.com"
    static let companyWebPageLink = "https://blocktechbrew.com"//"https://horizontalsystems.io"
    static let appWebPageLink = "https://blocktechbrew.com" //"https://unstoppable.money"
...
//        (Bundle.main.object(forInfoDictionaryKey: "CFBundleName") as? String) ?? ""
    ...
    static var gytscanKey: String {
        (Bundle.main.object(forInfoDictionaryKey: "GytScanApiKey") as? String) ?? ""
    }
