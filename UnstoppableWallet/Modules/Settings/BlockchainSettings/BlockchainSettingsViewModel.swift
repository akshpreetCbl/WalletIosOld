...
print(evmBlockchainManager.allBlockchains)
        ...
        let blck = Blockchain(type: .gala, name: "Gala", explorerUrl: "https:gytrace.com/token/$ref")
        let syncSource = evmSyncSourceManager.syncSource(blockchainType: .gala)
        
        let et = EvmItem(blockchain:blck , syncSource: syncSource)
        evmItems.append(et)
    }
}
